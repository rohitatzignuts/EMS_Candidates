...
/* styles for savedJobs page */
.savedJobs {
	min-height: calc(100vh - 64px);
}
/* styles for savedJobs container */
.savedJobsContainer {
	height: 75vh;
	overflow-x: hidden;
	overflow-y: scroll;
}
/* styles for savedJobs container scroll bar*/
.savedJobsContainer::-webkit-scrollbar {
	width: 8px;
	/* Width of the scrollbar */
}
/* styles for savedJobs container scroll bar*/
.savedJobsContainer::-webkit-scrollbar-track {
	background: #fefded;
	/* Color of the track */
}
/* styles for savedJobs container scroll bar thumb*/
.savedJobsContainer::-webkit-scrollbar-thumb {
	background: rgb(250, 112, 112, 0.75);
	/* Color of the scrollbar handle */
}
/* styles for savedJobs container scroll bar thumb*/
.savedJobsContainer::-webkit-scrollbar-thumb:hover {
	background: rgb(250, 112, 112, 0.75);
